...
def split_tiff(input_path, output_dir, target_patch_size=512, max_patch_size=500):
    """
    ...
    with rasterio.open(input_path) as src:
        ...
        for row in range(num_rows):
            for col in range(num_cols):
                ...
                output_path = output_dir / f"{base_name}_r{row}_c{col}.tif"
...
def split_image_and_mask_pairs(image_dir, mask_dir, output_image_dir, output_mask_dir, 
    ...
    """
    Split matching image and mask pairs into smaller patches.
    ...
    for image_path in image_files:
        ...
        # Split mask with same parameters
